...
class DiscreteVAE(nn.Module):
    ...
    def get_loss(self, ret, gt):
        ...
        loss_klv = F.kl_div(log_qy, log_uniform.expand(log_qy.size(0), log_qy.size(1)), size_average=None, reduce=None, reduction='batchmean', log_target=True)
    ...
    def forward(self, inp, temperature = 1., hard = False, **kwargs):
        ...
        ret = (whole_coarse, whole_fine, coarse, fine, neighborhood, logits, center)
        return ret
